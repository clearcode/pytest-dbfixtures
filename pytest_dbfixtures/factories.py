...
def rabbitmq_proc(config_file=None, server=None, host=None, port=None,
    ...
    def rabbitmq_proc_fixture(request):
        ...
        print 'rabbit_server', rabbit_server
        print 'rabbit_host', rabbit_host
        print 'rabbit_port', rabbit_port
        print 'os.environ'
        print 'RABBITMQ_NODE_PORT', os.getenv('RABBITMQ_NODE_PORT')
        print 'NODE_PORT', os.getenv('NODE_PORT')
        ...
        if rabbit_node_name:
            os.environ['RABBITMQ_NODENAME'] = rabbit_node_name
        else:
